...
/**
 * Class ItemDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from ItemFormBase. The reason for
 ...
 * @ingroup runescape
 */
class ItemDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete item %label?', [
  ...
  public function getCancelUrl() {
    return new Url('entity.item.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('Item %label was deleted.', [
      '%label' => $this->entity->label(),
    ]));
